        ...
        <div v-if="activeTab === 'books'" class="books-content">
          ...
          <div v-if="showBookAlert" class="book-selection-alert">
            ...
            <div class="alert-content">
              <div class="alert-title">请选择知识库来源</div>
              <div class="alert-message">至少选择一个知识库来源进行智能问答</div>
            </div>
          ...
          <div class="books-list">
            <div class="books-list-header">
              <div class="header-info">
                ...
                <span class="header-title">知识库来源</span>
                <span class="books-count">{{ filteredBooks.length }}项</span>
              </div>
              <div class="header-actions">
                <span v-if="selectedBooks.length > 0" class="selected-count">已选{{ selectedBooks.length }}项</span>
            ...
            <div class="books-scroll">
              <div v-if="filteredBooks.length === 0" class="empty-state">
                ...
                <div class="empty-text">未找到相关知识库</div>
      ...
      <div class="messages-container" ref="messagesContainer">
        <div v-if="messages.length === 0" class="welcome-message">
          <div class="welcome-content">
            ...
            <h2>欢迎使用船代智能问答助手</h2>
            <p>请输入您的船务问题，系统将为您提供专业解答与操作指引</p>
          </div>
        </div>
                ...
                <div v-if="message.isThinking" class="current-thinking">
                  ...
                  <div class="thinking-text">
                    ...
                    <div v-else-if="message.selectedBooks && message.selectedBooks.length > 0" class="thinking-with-books">
                      ...
                      <span v-if="message.selectedBooks.length > 3">等{{ message.selectedBooks.length }}个知识库</span>
                      来分析问题...
                    </div>
...
const loadAvailableBooks = async () => {
  try {
    ...
    if (books && books.length > 0) {
      ...
      console.log(`成功加载知识库列表，共${books.length}个来源`)

      // 如果有知识库来源但尚未选择，默认选择第一个
      if (books.length > 0 && selectedBooks.value.length === 0) {
        selectedBooks.value = [books[0]]
        console.log(`默认选择了「${books[0]}」`)
      }
    } else {
...
const handleSend = async () => {
  ...
  try {
    ...
    console.log('ChatView发送消息，选中的知识库:', selectedBooks.value)
